...
@ObjectClassDefinition(//
		name = "Controller Loadresponsive Peak-Shaving Symmetric", //
...
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Controller Load Responsive Peak-Shaving Symmetric [{id}]";
}