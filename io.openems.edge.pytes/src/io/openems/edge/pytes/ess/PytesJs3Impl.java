...
public class PytesJs3Impl extends AbstractOpenemsModbusComponent
		...
		OpenemsComponent, ModbusComponent, EventHandler, CycleProvider {
	...
	protected ModbusProtocol defineModbusProtocol() {
		return new ModbusProtocol(this, //
				...
				new FC3ReadRegistersTask(43111, Priority.LOW,
						m(PytesJs3.ChannelId.BACKUP_PORT_ENABLED, new UnsignedWordElement(43111))),				
				...
				new FC4ReadInputRegistersTask(33067, Priority.HIGH, //
						...
						m(PytesJs3.ChannelId.STANDARD_WORKING_MODE, new UnsignedWordElement(33091)), // Todo: Check what
																										// does it mean.
																										// Starts with
																										// WM 3???
	...
	private boolean setDefaultValues() {
	    ...
	    EnableDisable currentBackupPortState = this.getBackupPortEnabled();
	    ...
	    try {
	        ...
	        if (currentBackupPortState != targetBackupPortState) {
	            this.setEnableBackupPort(targetBackupPortState);
		        return false;
	        }
	...
	private void installListener() {
		...
		this.getRemoteDispatchRealtimeControlFunctionSwitchChannel().onUpdate(value -> {
			...
			int offGridBatteryStandbyBits = (raw >> 6) & 0b11;

			this.logDebug(this.log, "RemoteDispatchRealtimeControlFunctionSwitch raw=" + raw + " pv=" + pvShutdownBits
					+ " do=" + doControlBits + " grid=" + gridChargeBits + " standby=" + offGridBatteryStandbyBits);
	...
	/**
	 * Decodes the 7 Appendix-4 fault bitmask registers into individual boolean
	 * channels. Called every cycle from handleEvent().
	 */
	private void decodeFaultBits() {
		decodeBits(PytesJs3.ChannelId.FAULT_CODE_01, new PytesJs3.ChannelId[] { PytesJs3.ChannelId.FAULT_REG1_NO_GRID,
				PytesJs3.ChannelId.FAULT_REG1_GRID_OVERVOLTAGE, PytesJs3.ChannelId.FAULT_REG1_GRID_UNDERVOLTAGE,
				PytesJs3.ChannelId.FAULT_REG1_GRID_OVERFREQ, PytesJs3.ChannelId.FAULT_REG1_GRID_UNDERFREQ,
				PytesJs3.ChannelId.FAULT_REG1_UNBALANCED_GRID, PytesJs3.ChannelId.FAULT_REG1_GRID_FREQ_FLUCTUATION,
				PytesJs3.ChannelId.FAULT_REG1_GRID_REVERSE_CURRENT,
				PytesJs3.ChannelId.FAULT_REG1_GRID_CURRENT_TRACKING_ERROR, PytesJs3.ChannelId.FAULT_REG1_METER_COM_FAIL,
				PytesJs3.ChannelId.FAULT_REG1_FAILSAFE, PytesJs3.ChannelId.FAULT_REG1_METER_SELECT_FAIL,
				PytesJs3.ChannelId.FAULT_REG1_EPM_HARD_LIMIT, PytesJs3.ChannelId.FAULT_REG1_G100_CURRENT_OVER_LIMIT,
				PytesJs3.ChannelId.FAULT_REG1_RESERVED_14,
				PytesJs3.ChannelId.FAULT_REG1_ABNORMAL_GRID_PHASE_POLARITY });
		decodeBits(PytesJs3.ChannelId.FAULT_CODE_02,
				new PytesJs3.ChannelId[] { PytesJs3.ChannelId.FAULT_REG2_BACKUP_OVERVOLTAGE,
						...
						PytesJs3.ChannelId.FAULT_REG2_HUB_PANEL_OV_CURRENT, PytesJs3.ChannelId.FAULT_REG2_RESERVED_05,
						PytesJs3.ChannelId.FAULT_REG2_RESERVED_06, PytesJs3.ChannelId.FAULT_REG2_RESERVED_07,
						PytesJs3.ChannelId.FAULT_REG2_RESERVED_08, PytesJs3.ChannelId.FAULT_REG2_RESERVED_09,
						PytesJs3.ChannelId.FAULT_REG2_RESERVED_10, PytesJs3.ChannelId.FAULT_REG2_RESERVED_11,
						PytesJs3.ChannelId.FAULT_REG2_RESERVED_12, PytesJs3.ChannelId.FAULT_REG2_RESERVED_13,
						PytesJs3.ChannelId.FAULT_REG2_RESERVED_14, PytesJs3.ChannelId.FAULT_REG2_RESERVED_15 });
		decodeBits(PytesJs3.ChannelId.FAULT_CODE_03,
				new PytesJs3.ChannelId[] { PytesJs3.ChannelId.FAULT_REG3_BATTERY_NOT_CONNECTED,
						...
						PytesJs3.ChannelId.FAULT_REG3_LOW_BATTERY_OFFGRID, PytesJs3.ChannelId.FAULT_REG3_RESERVED_12,
						PytesJs3.ChannelId.FAULT_REG3_RESERVED_13, PytesJs3.ChannelId.FAULT_REG3_RESERVED_14,
						PytesJs3.ChannelId.FAULT_REG3_RESERVED_15 });
		decodeBits(PytesJs3.ChannelId.FAULT_CODE_04, new PytesJs3.ChannelId[] {
				PytesJs3.ChannelId.FAULT_REG4_DC_OVERVOLTAGE, PytesJs3.ChannelId.FAULT_REG4_DC_BUS_OVERVOLTAGE,
				...
				PytesJs3.ChannelId.FAULT_REG4_DC_OVERCURRENT_A, PytesJs3.ChannelId.FAULT_REG4_DC_OVERCURRENT_B,
				PytesJs3.ChannelId.FAULT_REG4_DC_INPUT_INTERFERENCE, PytesJs3.ChannelId.FAULT_REG4_GRID_OVERCURRENT,
				PytesJs3.ChannelId.FAULT_REG4_IGBT_OVERCURRENT, PytesJs3.ChannelId.FAULT_REG4_GRID_INTERFERENCE_02,
				PytesJs3.ChannelId.FAULT_REG4_AFCI_SELF_CHECK, PytesJs3.ChannelId.FAULT_REG4_ARC_FAULT_RESERVED,
		...
		decodeBits(PytesJs3.ChannelId.FAULT_CODE_05, new PytesJs3.ChannelId[] {
				PytesJs3.ChannelId.FAULT_REG5_GRID_INTERFERENCE, PytesJs3.ChannelId.FAULT_REG5_OVER_DC_COMPONENTS,
				PytesJs3.ChannelId.FAULT_REG5_OVER_TEMPERATURE, PytesJs3.ChannelId.FAULT_REG5_RELAY_CHECK,
				PytesJs3.ChannelId.FAULT_REG5_UNDER_TEMPERATURE, PytesJs3.ChannelId.FAULT_REG5_PV_INSULATION_FAULT,
				PytesJs3.ChannelId.FAULT_REG5_12V_UNDERVOLTAGE, PytesJs3.ChannelId.FAULT_REG5_LEAK_CURRENT,
				PytesJs3.ChannelId.FAULT_REG5_LEAK_CURRENT_SELF_CHECK, PytesJs3.ChannelId.FAULT_REG5_DSP_INITIAL,
				PytesJs3.ChannelId.FAULT_REG5_DSP_B, PytesJs3.ChannelId.FAULT_REG5_BATTERY_OVERVOLTAGE_HW,
				PytesJs3.ChannelId.FAULT_REG5_LLC_HW_OVERCURRENT,
				PytesJs3.ChannelId.FAULT_REG5_GRID_TRANSIENT_OVERCURRENT,
				PytesJs3.ChannelId.FAULT_REG5_BATTERY_COM_FAILURE, PytesJs3.ChannelId.FAULT_REG5_DSP_COM_FAIL });
		decodeBits(PytesJs3.ChannelId.FAULT_CODE_06,
				new PytesJs3.ChannelId[] { PytesJs3.ChannelId.FAULT_REG6_SLAVE_LOSE_ERR,
						PytesJs3.ChannelId.FAULT_REG6_MASTER_LOSE_ERR, PytesJs3.ChannelId.FAULT_REG6_SLAVE_PRD_ERR,
						PytesJs3.ChannelId.FAULT_REG6_MASTER_PRD_ERR, PytesJs3.ChannelId.FAULT_REG6_ADDR_CONFLICT,
						PytesJs3.ChannelId.FAULT_REG6_HEARTBEAT_LOSE, PytesJs3.ChannelId.FAULT_REG6_DCAN_ERR,
						PytesJs3.ChannelId.FAULT_REG6_MUL_MASTER_ERR, PytesJs3.ChannelId.FAULT_REG6_MODE_CONFLICT,
						PytesJs3.ChannelId.FAULT_REG6_S_PLUG_VOLT_ERR, PytesJs3.ChannelId.FAULT_REG6_OTHERS_FAULT,
						PytesJs3.ChannelId.FAULT_REG6_CAN_BUS_LOSE, PytesJs3.ChannelId.FAULT_REG6_MODEL_MISMATCH,
						PytesJs3.ChannelId.FAULT_REG6_3P_CREATE_FAIL, PytesJs3.ChannelId.FAULT_REG6_ACBK_OPEN,
						PytesJs3.ChannelId.FAULT_REG6_RESERVED_15 });
		decodeBits(PytesJs3.ChannelId.FAULT_CODE_07, new PytesJs3.ChannelId[] { PytesJs3.ChannelId.FAULT_REG7_REVE_DC,
				...
				PytesJs3.ChannelId.FAULT_REG7_BATTERY_STARTUP_FAIL, PytesJs3.ChannelId.FAULT_REG7_DC3_AVG_OVERCURRENT,
				PytesJs3.ChannelId.FAULT_REG7_DC4_AVG_OVERCURRENT, PytesJs3.ChannelId.FAULT_REG7_SOFTRUN_TIMEOUT,
				PytesJs3.ChannelId.FAULT_REG7_OFFGRID_TO_GRID_TIMEOUT, PytesJs3.ChannelId.FAULT_REG7_DRM_NOT_CONNECT,
				PytesJs3.ChannelId.FAULT_REG7_RESERVED_10, PytesJs3.ChannelId.FAULT_REG7_RESERVED_11,
				PytesJs3.ChannelId.FAULT_REG7_RESERVED_12, PytesJs3.ChannelId.FAULT_REG7_RESERVED_13,
				PytesJs3.ChannelId.FAULT_REG7_RESERVED_14, PytesJs3.ChannelId.FAULT_REG7_RESERVED_15 });

		// Appendix 5 � Operating Status register 33121
		decodeBits(PytesJs3.ChannelId.OPERATING_STATUS, new PytesJs3.ChannelId[] {
				PytesJs3.ChannelId.OPERATING_STAT_NORMAL_OPERATION, PytesJs3.ChannelId.OPERATING_STAT_INITIALIZING,
				PytesJs3.ChannelId.OPERATING_STAT_CONTROLLED_OFF, PytesJs3.ChannelId.OPERATING_STAT_FAULT_OFF,
				PytesJs3.ChannelId.OPERATING_STAT_STANDBY, PytesJs3.ChannelId.OPERATING_STAT_LIMITED_TEMP_FREQ,
				PytesJs3.ChannelId.OPERATING_STAT_LIMITED_EXTERNAL, PytesJs3.ChannelId.OPERATING_STAT_BACKUP_OVERLOAD,
				PytesJs3.ChannelId.OPERATING_STAT_LOAD_FAULT, PytesJs3.ChannelId.OPERATING_STAT_GRID_FAULT,
				PytesJs3.ChannelId.OPERATING_STAT_BATTERY_FAULT, PytesJs3.ChannelId.OPERATING_STAT_RESERVED_11,
				PytesJs3.ChannelId.OPERATING_STAT_GRID_SURGE_WARN, PytesJs3.ChannelId.OPERATING_STAT_FAN_FAULT_WARN,
				PytesJs3.ChannelId.OPERATING_STAT_EXTERNAL_FAN_FAIL, PytesJs3.ChannelId.OPERATING_STAT_RESERVED_15 });
		...
		decodeBits(PytesJs3.ChannelId.STORAGE_CONTROL_SWITCHING_VALUE, new PytesJs3.ChannelId[] {
				PytesJs3.ChannelId.STORAGE_CTRL_SELF_USE_MODE, PytesJs3.ChannelId.STORAGE_CTRL_TIME_OF_USE_MODE,
				PytesJs3.ChannelId.STORAGE_CTRL_OFFGRID_MODE, PytesJs3.ChannelId.STORAGE_CTRL_BATT_WAKEUP,
				PytesJs3.ChannelId.STORAGE_CTRL_RESERVE_BATT_MODE, PytesJs3.ChannelId.STORAGE_CTRL_ALLOW_GRID_CHARGE,
				PytesJs3.ChannelId.STORAGE_CTRL_FEED_IN_PRIORITY, PytesJs3.ChannelId.STORAGE_CTRL_BATT_OVC,
				PytesJs3.ChannelId.STORAGE_CTRL_FORCE_CHARGE_PEAKSHAVING,
				PytesJs3.ChannelId.STORAGE_CTRL_BATT_CURRENT_CORRECTION,
				PytesJs3.ChannelId.STORAGE_CTRL_BATT_HEALING_MODE, PytesJs3.ChannelId.STORAGE_CTRL_PEAK_SHAVING_MODE,
				PytesJs3.ChannelId.STORAGE_CTRL_RESERVED_12, PytesJs3.ChannelId.STORAGE_CTRL_RESERVED_13,
				PytesJs3.ChannelId.STORAGE_CTRL_RESERVED_14, PytesJs3.ChannelId.STORAGE_CTRL_RESERVED_15 });

		// Appendix 7 � Setting Flag Bit register 33115
		decodeBits(PytesJs3.ChannelId.SETTING_FLAG_BIT,
				new PytesJs3.ChannelId[] { PytesJs3.ChannelId.SETTING_FLAG_FLASH_TIMEOUT,
						PytesJs3.ChannelId.SETTING_FLAG_CLEAR_ENERGY, PytesJs3.ChannelId.SETTING_FLAG_RESERVED_02,
						PytesJs3.ChannelId.SETTING_FLAG_RESERVED_03, PytesJs3.ChannelId.SETTING_FLAG_RESERVED_04,
						PytesJs3.ChannelId.SETTING_FLAG_RESERVED_05, PytesJs3.ChannelId.SETTING_FLAG_RESERVED_06,
						PytesJs3.ChannelId.SETTING_FLAG_RESERVED_07, PytesJs3.ChannelId.SETTING_FLAG_RESET_DATALOGGER,
						PytesJs3.ChannelId.SETTING_FLAG_FACTORY_RECOVER, PytesJs3.ChannelId.SETTING_FLAG_RESERVED_10,
						PytesJs3.ChannelId.SETTING_FLAG_RESERVED_11, PytesJs3.ChannelId.SETTING_FLAG_RESERVED_12,
						PytesJs3.ChannelId.SETTING_FLAG_RESERVED_13, PytesJs3.ChannelId.SETTING_FLAG_RESERVED_14,
	...
	/**
	 * Reads a raw integer channel and sets 16 boolean channels, one per bit. BIT0 ?
	 * bits[0], BIT1 ? bits[1], ... BIT15 ? bits[15]
	 */
