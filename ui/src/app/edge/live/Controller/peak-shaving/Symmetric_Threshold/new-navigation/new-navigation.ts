...
@Component({
    selector: "oe-controller-peak-shaving-symmetric-threshold",
    templateUrl:
...
export class ControllerPeakShavingSymmetricThresholdHomeComponent extends AbstractFormlyComponent {
    ...
    public static getFormlyGeneralView(
        ...
        return {
            ...
            lines: SharedControllerThresholdPeakshaving.getFormlyFlatLines(
                translate,
                component,
            ),
            component: component,
    ...
    protected override generateView(): OeFormlyView {
        ...
        return ControllerPeakShavingSymmetricThresholdHomeComponent.getFormlyGeneralView(
            this.translate,
            component,
        );
    }
